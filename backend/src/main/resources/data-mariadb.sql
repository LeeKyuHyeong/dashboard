...
(1, 'ITSM', 'itsm', 'Vue.js 프론트엔드와 Spring Boot 백엔드로 구축한 IT 서비스 관리 시스템. IT 서비스 요청, 장애, 변경 사항을 체계적으로 관리합니다.',
 ...
 'https://itsm.kyuhyeong.com', 'https://github.com/LeeKyuHyeong/itsm', '/thumbnails/itsm.png', 1, NOW(), NOW()),
(2, 'Song Quiz', 'song-quiz', '실시간 멀티플레이어 노래 맞추기 게임. 짧은 음악 클립을 듣고 누가 가장 빠르게 곡을 맞추는지 겨루는 게임입니다.',
 ...
 'https://game.kyuhyeong.com', 'https://github.com/LeeKyuHyeong/quiz', '/thumbnails/song-quiz.png', 2, NOW(), NOW()),
...
(3, 'Account', 'account', '부부/가구 단위 가계부 앱. 영수증 사진을 Claude Vision 으로 분석해 지출을 자동 분류·기록합니다.',
 ...
 'https://account.kyuhyeong.com', 'https://github.com/LeeKyuHyeong/account', NULL, 3, NOW(), NOW());

-- Insert achievements
INSERT IGNORE INTO project_achievement (id, project_id, title, description, metric_value, sort_order, created_at) VALUES
(1, 1, '서비스 요청 자동화', 'IT 서비스 요청 워크플로우를 자동화하여 수작업 처리 시간을 단축', '70% 감소', 1, NOW()),
(2, 1, '역할 기반 접근 제어', '부서 단위 권한을 포함한 체계적인 RBAC 구현', NULL, 2, NOW()),
