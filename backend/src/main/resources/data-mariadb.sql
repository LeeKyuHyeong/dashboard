...
(3, 'Account', 'account', '영수증 이미지를 Claude API 로 분석해 지출을 자동 기록하는 가계부 서비스.',
 '["Spring Boot", "MariaDB", "Docker", "Claude API"]',
 'https://account.kyuhyeong.com', 'https://github.com/rbgud/account', NULL, 3, NOW(), NOW());
...
(5, 3, '영수증 자동 분석', 'Claude API 로 영수증 이미지를 파싱해 품목·금액을 자동 입력', NULL, 1, NOW());
